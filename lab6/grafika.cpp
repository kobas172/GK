...
GLuint vao[5], vbo[14], ebo, tex[2];	// identyfikatory poszczegolnych obiektow (obiekty tablic wierzcholkow, buforow wierzcholkow, elementow, tekstury)
double fi = 1.0f;
...
float pixels_wall[] = { //tekstura o wymiarach 2x2; dla kazdego punktu okreslone skladowe RGB koloru 
