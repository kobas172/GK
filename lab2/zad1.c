  ...
  while (to_end == FALSE)
  {
    ...
    switch(event.type)
    {
      case Expose:
        ...
        {
    		drawC(display, window, gc, -50,  10, 250, green);
    		drawC(display, window, gc, 180,  10, 250, blue);
    		drawP(display, window, gc, 0, 0, 10, 10, red, black);
	...
	drawC(display, window, gc, -150+mousePosition.x,  mousePosition.y-40, 250, green);
	drawP(display, window, gc, mousePosition.x-100, mousePosition.y-50, 10, 10, red, black);
	drawC(display, window, gc, 180,  10, 250, blue);
	drawG(display, window, gc, 0, 0, 10, 10, red, black);              
